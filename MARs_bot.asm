...
main: 	
	jal UNTRACK 		# moving without drawing
 	...
 	nop
sleep1: 
	addi $v0, $zero,32 	# Keep running by sleeping in 7500ms
 	li $a0,7500 
 	syscall
...
goLEFT: 
	addi $a0, $zero, 270 	# Marsbot rotates 270* 
 	...
 	nop 
sleep3: 
	addi $v0, $zero,32 	# Keep running by sleeping in 7500 ms 
 	li $a0,7500
 	syscall
 	jal UNTRACK 		# keep old track
 	nop
...
sleep4: 
	addi $v0, $zero,32 	# Keep running by sleeping in 10000 ms 
 	li $a0,10000
 	syscall 
 	jal UNTRACK 		# keep old track
 	nop
