...
test_length: 
	...
	div $t3,$t2
	mfhi $t4
	bnez $t4,error1		# neu 3 bit cuoi khac 0 thi ko chia het cho 8			
        j print_title
error1: li $v0, 4
        la $a0, error_length
        syscall
...
b31:	xor $a3, $t1, $t2	# tinh parity
	sb $a3, ($a2)		
	addi $a2, $a2, 3	# tang den 4 byte tiep theo cua mang array
...
print14:lb $t8, ($a2)		# in tung gia tri parity tu mang array vao vi tri disk3
	...
	addi $t9, $t9, 1
	addi $a2, $a2, 3
	bgt $t9, 1, end1	# in ra 3 parity dau co dau ",", parity cuoi cung k co
	j print14	
end1:	lb $t8, ($a2)
	jal HEX
	li $v0, 4
